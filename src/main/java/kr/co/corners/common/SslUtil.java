...
public class SslUtil {
    ...
    //                                                final String password) {
        try {
            ...
            File file1 = new ClassPathResource("static/cert/cacert.crt").getFile();
            String caCrtFile = file1.getAbsolutePath();
            
            File file2 = new ClassPathResource("static/cert/client.crt").getFile();
            String crtFile = file2.getAbsolutePath();
            
            File file3 = new ClassPathResource("static/cert/client.key").getFile();
            String keyFile = file3.getAbsolutePath();
            
    //File file = new ClassPathResource(caCrtFile).getFile();
